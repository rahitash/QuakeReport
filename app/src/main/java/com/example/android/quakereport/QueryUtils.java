...
public final class QueryUtils {
    ...
    public static ArrayList<Quake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray features_array = sample_json.getJSONArray("features");
             for (int i=0; i<features_array.length(); i++) {
                 JSONObject earthquake_object = features_array.getJSONObject(i);
                 JSONObject properties_object = earthquake_object.getJSONObject("properties");

                 String magnitude = properties_object.getString("mag");
                 String place = properties_object.getString("place");
                 String time = properties_object.getString("time");
